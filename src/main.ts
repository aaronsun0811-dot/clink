...
// ---- i18n ----
type Lang = "zh" | "en";
let lang: Lang = (localStorage.getItem("clink.lang") as Lang) || "zh";

const I18N: Record<string, { zh: string; en: string }> = {
  skills: { zh: "技能", en: "Skills" },
  history: { zh: "历史", en: "History" },
  addColumn: { zh: "＋面板", en: "+ Column" },
  newBtn: { zh: "新建", en: "New" },
  openFolder: { zh: "打开", en: "Open" },
  openFailed: { zh: "打开失败: ", en: "Open failed: " },
  langToggle: { zh: "EN", en: "中" },
  refresh: { zh: "刷新", en: "Refresh" },
  hint: { zh: "点工具栏 / 技能会作用于「高亮」面板", en: "Toolbar / skills act on the highlighted column" },
  import: { zh: "＋ 导入", en: "+ Import" },
  filterSkills: { zh: "筛选 name / 描述…", en: "Filter name / description…" },
  all: { zh: "全部", en: "All" },
  newFileTitle: { zh: "新建文件 / 文件夹", en: "New file / folder" },
  cancel: { zh: "取消", en: "Cancel" },
  makeDir: { zh: "建文件夹", en: "New folder" },
  makeFile: { zh: "建文件", en: "New file" },
  importTitle: { zh: "导入技能（复制文件夹）", en: "Import skill (copy folder)" },
  importTo: { zh: "导入到：", en: "Import to:" },
  importSrcPh: { zh: "技能文件夹路径，如 ~/Downloads/my-skill", en: "Skill folder path, e.g. ~/Downloads/my-skill" },
  importNeedSkill: { zh: "文件夹里需包含 SKILL.md", en: "Folder must contain SKILL.md" },
  importBtn: { zh: "导入", en: "Import" },
  chooseFolder: { zh: "选择文件夹", en: "Choose folder" },
  historyTitle: { zh: "历史会话（点一下续接）", en: "History (click to resume)" },
  historyFilterPh: { zh: "筛选标题 / 目录…", en: "Filter title / dir…" },
  close: { zh: "关闭", en: "Close" },
  dir: { zh: "目录", en: "Dir" },
  argsLabel: { zh: "参数", en: "Args" },
  pick: { zh: "选", en: "Pick" },
  argsPh: { zh: "如 --continue / --resume", en: "e.g. --continue / --resume" },
  newTab: { zh: "新标签", en: "New tab" },
  closeTab: { zh: "关闭标签", en: "Close tab" },
  procExited: { zh: "[进程已退出]", en: "[process exited]" },
  launchFailed: { zh: "启动失败: ", en: "Launch failed: " },
  loading: { zh: "加载中…", en: "Loading…" },
  readFailed: { zh: "读取失败: ", en: "Read failed: " },
  noSkills: { zh: "无匹配技能", en: "No matching skills" },
  clickDisable: { zh: "点击禁用", en: "Click to disable" },
  clickEnable: { zh: "点击启用", en: "Click to enable" },
  toggleFailed: { zh: "切换失败: ", en: "Toggle failed: " },
  insertInto: { zh: "点击插入到 # 面板", en: "Click to insert into # pane" },
  openToolFirst: { zh: "请先开一个 # 面板", en: "Open a # pane first" },
  maxColumns: { zh: "最多 # 列，列内可加无限标签", en: "Max # columns; unlimited tabs per column" },
  dropped: { zh: "已填入拖入的文件夹，选好工具后点导入", en: "Dropped folder filled in; pick a tool and import" },
  enterPath: { zh: "请输入路径", en: "Enter a path" },
  enterFolder: { zh: "请输入文件夹路径", en: "Enter a folder path" },
  created: { zh: "已创建: ", en: "Created: " },
  noSessions: { zh: "无匹配会话", en: "No matching sessions" },
  untitled: { zh: "(无标题)", en: "(untitled)" },
  pin: { zh: "置顶", en: "Pin" },
  del: { zh: "删除", en: "Delete" },
  delConfirm: {
    zh: "删除该 # 会话？会从磁盘移除对应文件，不可恢复。",
    en: "Delete this # session? Files are removed from disk and cannot be recovered.",
  },
  delFailed: { zh: "删除失败: ", en: "Delete failed: " },
};

function tr(key: string, arg?: string): string {
  const s = I18N[key]?.[lang] ?? key;
